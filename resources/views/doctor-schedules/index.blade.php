                        ...
                        <tbody>
                            @foreach ($schedules as $schedule)
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::createFromFormat('H:i:s', $schedule->dcs_start)->isoFormat('HH:mm') }}
                                        -
                                        {{ \Carbon\Carbon::createFromFormat('H:i:s', $schedule->dcs_end)->isoFormat('HH:mm') }}
                                    </td>
